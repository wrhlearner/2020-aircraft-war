...
BossNpc::BossNpc(char* PictureMap, int Name, double Width, double Height, double PosX, double PosY, double Speed, MOVEDIRECTION Direction, bool Exist, int Blood, int FirePower, int Number) :Npc(PictureMap, Name, Width, Height, PosX, PosY, Speed, Direction, Exist, Blood, FirePower, Number) {}
